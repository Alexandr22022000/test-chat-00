...
},{"./debug":2,"qC859L":5}],2:[function(require,module,exports){
...
var registration = require('./scripts/registration');

document.addEventListener('DOMContentLoaded', function () {
    document.getElementById('login__go-to-registration').onclick = function () {
        document.getElementById('registration').style.display = 'block';
        document.getElementById('login').style.display = 'none';
    };

    document.getElementById('registration__go-to-login').onclick = function () {
        document.getElementById('registration').style.display = 'none';
        document.getElementById('login').style.display = 'block';
    };

    document.getElementById('registration__run').onclick = function () {
...
},{"./scripts/registration":7}],7:[function(require,module,exports){
